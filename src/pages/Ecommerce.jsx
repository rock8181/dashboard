  ...
  return (
    <div className="mt-12">
      <div className="flex flex-wrap lg:flex-nowrap justify-center ">
        ...
        rounded-xl w-full lg:w-780 p-8 pt-9 m-3 bg-hero-pattern bg-no-repeat bg-cover bg-center">
      ...
      <div className="flex gap-10 flex-wrap justify-center ">
        <div className="bg-white dark:text-gray-200 dark:bg-secondary-dark-bg 
          ...
          <div className="flex justify-between">
            <p className="font-semibold text-2xl bg-green">Revenue Updates</p>
          ...
          <div className="mt-10 flex gap-10 flex-wrap justify-center">
            <div className=" border-r-1 border-color m-4 pr-10">
              <div>
                <p>
                  ...
                  <span className="p-1.5 hover:drop-shadow-xl cursor-pointer rounded-full text-white bg-green-800 ml-3 text-xs">
                    23%
                  </span>
                </p>
              ...
              <div className="mt-5">
                <SparkLine
                  currentColor="blue" id="line-sparkLine"
                  type="Line" height="80px" width="250px" data={SparklineAreaData} color="blue"
                  />                        
              </div>
              <div className='mt-10'>
            ...
            <div>
              <Stacked width="320px" hegit="360px"/>
            </div>                               
          </div>   
